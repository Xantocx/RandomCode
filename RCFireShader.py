...
# I only made it run, check out his website:
...
vertex_shader=compileShader(vertexShader, GL_VERTEX_SHADER);
...
fire_shader=compileShader(fireShader, GL_FRAGMENT_SHADER);
...
color_shader=compileShader(colorShader, GL_FRAGMENT_SHADER);
